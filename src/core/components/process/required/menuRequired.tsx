        ...
        <>
            ...
            <Menu anchorEl={menuAnchorEl} open={Boolean(menuAnchorEl)} onClose={handleClose}>
                <MenuItem onClick={() => openReport(data['id'])}>
                    <VisibilityIcon /> &nbsp; Ver Requerimiento
                </MenuItem>
                <MenuItem onClick={() => navigate('/operaciones/requerimientos/edit/' + data['id'])} disabled={data['cantidadOrden'] != '0'}>
                    <EditIcon /> &nbsp; Editar
                </MenuItem>
                <MenuItem onClick={() => setOpen(true)} disabled={parseInt(data['cantidadOrden']) >= parseInt(data['cantidadTotal'])}>
                    <DocumentScannerIcon /> &nbsp; Generar Solicitud
                </MenuItem>
                <MenuItem onClick={() => navigate('/operaciones/ordencompras/nuevo/' + data['id'])} disabled={parseInt(data['cantidadOrden']) >= parseInt(data['cantidadTotal'])}>
                    <LocalMallIcon /> &nbsp; Generar Orden de Compra
                </MenuItem>
                <MenuItem onClick={() => cancelRequired(data['id'])} disabled={data['cantidadOrden'] != 0}>
                    <DeleteIcon /> &nbsp; Anular
                </MenuItem>
            </Menu>
            <Dialog
